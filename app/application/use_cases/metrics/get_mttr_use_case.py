...
class GetMTTRUseCase:
    ...
    def execute(self, project: str, environment: str, start_dt: Optional[datetime] = None, end_dt: Optional[datetime] = None, last_runs: Optional[int] = None) -> MTTRSummary:
        try:
            logger.info("Executing GetMTTRUseCase for project: %s", project)
            return self.metrics_repository.get_mttr(project, environment, start_dt, end_dt, last_runs)
